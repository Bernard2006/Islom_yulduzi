...
from keyboards.inline.erkak_asr import *
...
@dp.callback_query_handler(text='asr_davom1')
...
@dp.callback_query_handler(text='asr_davom2')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
...
@dp.callback_query_handler(text='asr_davom3')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
...
@dp.callback_query_handler(text='asr_davom4')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/niyat.png')
...
@dp.callback_query_handler(text='asr_davom5')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
...
@dp.callback_query_handler(text='asr_davom6')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
...
@dp.callback_query_handler(text='asr_davom7')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom8')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/qiyom.png')
...
@dp.callback_query_handler(text='asr_davom9')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/ruku.png')
...
@dp.callback_query_handler(text='asr_davom10')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/niyat.png')
...
@dp.callback_query_handler(text='asr_davom11')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom12')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/jalsa.png')
...
@dp.callback_query_handler(text='asr_davom13')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom14')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/jalsa.png')
...
@dp.callback_query_handler(text='asr_davom15')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/qiyom.png')
...
@dp.callback_query_handler(text='asr_davom16')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/ruku.png')
...
@dp.callback_query_handler(text='asr_davom17')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/niyat.png')
...
@dp.callback_query_handler(text='asr_davom18')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom19')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/jalsa.png')
...
@dp.callback_query_handler(text='asr_davom20')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom21')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/qiyom.png')
...
@dp.callback_query_handler(text='asr_davom22')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/ruku.png')
...
@dp.callback_query_handler(text='asr_davom23')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/niyat.png')
...
@dp.callback_query_handler(text='asr_davom24')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom25')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/jalsa.png')
...
@dp.callback_query_handler(text='asr_davom26')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/sajda.png')
...
@dp.callback_query_handler(text='asr_davom27')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/jalsa.png')
...
@dp.callback_query_handler(text='asr_davom28')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
...
@dp.callback_query_handler(text='asr_davom29')
async def bot_echo(request: CallbackQuery):
    user_id = request.from_user.id
    niyat = InputFile(path_or_bytesio='photos/salom.png')
